...
def plot_metrics(metrics_list: List[Metrics],
...
def plot_all_metrics(metrics_list: List[Metrics],
                    save_path: Optional[str] = None) -> None:
    """
...
def plot_parameter_sensitivity(results: dict,
                              param_name: str,
    ...
    ax.errorbar(param_values, mean_metrics, yerr=std_metrics, 
...
def plot_confusion_heatmap(confusion_matrix: np.ndarray,
                          labels: List[str],
                          save_path: Optional[str] = None) -> None:
    """
