...
def euclidean_distance(p1: Union[npt.NDArray[np.float64], Example, SPFMiC],
                       p2: Union[npt.NDArray[np.float64], Example, SPFMiC]) -> float:
    """
...
def calculate_pertinence(point: npt.NDArray[np.float64],
                        centroid: npt.NDArray[np.float64],
                        fuzzification: float) -> float:
    """
...
def batch_euclidean_distance(points: npt.NDArray[np.float64],
                             centroid: npt.NDArray[np.float64]) -> npt.NDArray[np.float64]:
    """
